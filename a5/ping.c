 ...
 * ICS 451 PROGRAM 5
 * ping.c
 * This program will emulate the ping command on Terminal/cmd prompt
 * and send RTT statistics when the user presses CTRL+C to halt.
 */
